 ...
 * Version            : V1.0
 * Date               : 13/06/2026
 * Description        : CH32V00x Modified file
 *********************************************************************************
 * The original file was most likely copied from another chip somewhere 
 * does not match the datasheet, so I redid it.
 * P.S. I also cleaned up a bit of the junk, so this
 * **NOT INTERCHANGEABLE with the official SDK and SPL**
 * 
 * Оригинальный файл скорее всего скопипащен с другого чипа и где-то 
 * несоответствует даташиту, поэтому я его переделал.
 * p.s. Я в целом еще немного мусора почистил, так что это 
 * **НЕ ВЗАИМОЗАМЕНЯЕМО с оф. SDK и SPL** 
 *******************************************************************************/
#ifndef __CH32V00x_H
#define __CH32V00x_H
...
#define AFIO_PCFR1_I2C1_REMAP                   ((uint32_t)0x00400002) /* I2C1 remapping */
#define AFIO_PCFR1_I2C1_REMAP_0                 ((uint32_t)0x00000002) /* bit 0 */
#define AFIO_PCFR1_I2C1_REMAP_1                 ((uint32_t)0x00400000) /* bit 1 */

#define AFIO_PCFR1_I2C1_REMAP_NOREMAP         ((uint32_t)0x00000000) /* No remap (SCL/PC2, SDA/PC1) */
#define AFIO_PCFR1_I2C1_REMAP_REMAP1          ((uint32_t)0x00000002) /* remap 1 (SCL/PD1, SDA/PD0) */
#define AFIO_PCFR1_I2C1_REMAP_REMAP2          ((uint32_t)0x00400000) /* remap 2 (SCL/PC5, SDA/PC6) */

#define AFIO_PCFR1_USART1_REMAP                 ((uint32_t)0x00200004) /* USART1 remapping */
#define AFIO_PCFR1_USART1_REMAP_0               ((uint32_t)0x00000004) /* USART1 remapping low bit */
#define AFIO_PCFR1_USART1_REMAP_1               ((uint32_t)0x00200000) /* USART1 remapping high bit */

#define AFIO_PCFR1_USART1_REMAP_NOREMAP         ((uint32_t)0x00000000) /* No remap (CK/PD4, TX/PD5, RX/PD6, CTS/PD3, RTS/PC2) */
#define AFIO_PCFR1_USART1_REMAP_REMAP1          ((uint32_t)0x00000004) /* remap 1 (CK/PD7, TX/PD0, RX/PD1, CTS/PC3, RTS/PC2, SW_RX/PD0) */
#define AFIO_PCFR1_USART1_REMAP_REMAP2          ((uint32_t)0x00200000) /* remap 2 (CK/PD7, TX/PD6, RX/PD5, CTS/PC6, RTS/PC7, SW_RX/PD6) */
#define AFIO_PCFR1_USART1_REMAP_REMAP3          ((uint32_t)0x00200004) /* remap 3 (CK/PC5, TX/PC0, RX/PC1, CTS/PC6, RTS/PC7, SW_RX/PC0)) */
...
#define AFIO_PCFR1_TIM1_IREMAP                  ((uint32_t)0x00800000) /* TIM1 channel 1 selection: 1 - LSI clock; 0 - external pins. */
...
#define AFIO_EXTICR_EXTI4                      ((uint16_t)0x0300) /* EXTI 3 configuration */
#define AFIO_EXTICR_EXTI5                      ((uint16_t)0x0C00) /* EXTI 3 configuration */
#define AFIO_EXTICR_EXTI6                      ((uint16_t)0x3000) /* EXTI 3 configuration */
#define AFIO_EXTICR_EXTI7                      ((uint16_t)0xC000) /* EXTI 3 configuration */

#define AFIO_EXTICR_EXTI0_PA                   ((uint16_t)0x0000) /* PA[0] pin */
// #define AFIO_EXTICR_EXTI0_PB                   ((uint16_t)0x0001) /* PB[0] pin */
...
// #define AFIO_EXTICR_EXTI1_PB                   ((uint16_t)0x0004) /* PB[1] pin */
...
// #define AFIO_EXTICR_EXTI2_PB                   ((uint16_t)0x0010) /* PB[2] pin */
#define AFIO_EXTICR_EXTI2_PC                   ((uint16_t)0x0020) /* PC[2] pin */
#define AFIO_EXTICR_EXTI2_PD                   ((uint16_t)0x0030) /* PD[2] pin */

#define AFIO_EXTICR_EXTI3_PA                   ((uint16_t)0x0000) /* PA[3] pin */
// #define AFIO_EXTICR_EXTI3_PB                   ((uint16_t)0x0040) /* PB[3] pin */
#define AFIO_EXTICR_EXTI3_PC                   ((uint16_t)0x0080) /* PC[3] pin */
#define AFIO_EXTICR_EXTI3_PD                   ((uint16_t)0x00C0) /* PD[3] pin */

#define AFIO_EXTICR_EXTI4_PA                   ((uint16_t)0x0000) /* PA[4] pin */
// #define AFIO_EXTICR_EXTI4_PB                   ((uint16_t)0x0100) /* PB[4] pin */
#define AFIO_EXTICR_EXTI4_PC                   ((uint16_t)0x0200) /* PC[4] pin */
#define AFIO_EXTICR_EXTI4_PD                   ((uint16_t)0x0300) /* PD[4] pin */

#define AFIO_EXTICR_EXTI5_PA                   ((uint16_t)0x0000) /* PA[5] pin */
// #define AFIO_EXTICR_EXTI5_PB                   ((uint16_t)0x0400) /* PB[5] pin */
#define AFIO_EXTICR_EXTI5_PC                   ((uint16_t)0x0800) /* PC[5] pin */
#define AFIO_EXTICR_EXTI5_PD                   ((uint16_t)0x0C00) /* PD[5] pin */

#define AFIO_EXTICR_EXTI6_PA                   ((uint16_t)0x0000) /* PA[6] pin */
// #define AFIO_EXTICR_EXTI6_PB                   ((uint16_t)0x1000) /* PB[6] pin */
#define AFIO_EXTICR_EXTI6_PC                   ((uint16_t)0x2000) /* PC[6] pin */
#define AFIO_EXTICR_EXTI6_PD                   ((uint16_t)0x3000) /* PD[6] pin */

#define AFIO_EXTICR_EXTI7_PA                   ((uint16_t)0x0000) /* PA[7] pin */
// #define AFIO_EXTICR_EXTI7_PB                   ((uint16_t)0x4000) /* PB[7] pin */
